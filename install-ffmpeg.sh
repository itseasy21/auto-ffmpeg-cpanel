...
# ffmpeg 0.7.11, mencoder, mplayer, mp4box2, flvtools2 and more libs
...
echo -e " 
    ...
    flvtool2:$GREEN /usr/bin/flvtool2 $RESET
...
echo -e ""
echo -e "Thanks for using our FFMpeg Installer for CPanel"
